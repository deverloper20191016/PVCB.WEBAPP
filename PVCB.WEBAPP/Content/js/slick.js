...
;(function(factory) {
    ...
    Slick.prototype.getOuterEdgeLimit = function(includeWidth) {
        var _ = this;
        var lastSlide,
            lastLeft;
        lastSlide = _.$slides.last();
        lastLeft = lastSlide[0] ? lastSlide[0].offsetLeft * -1 : 0;
        return includeWidth ? lastLeft + _.$list.width() : lastLeft - lastSlide.width() + _.$list.width();
    };

    Slick.prototype.getOuterEdgeSlideNumber = function() {
        var _ = this,
            outEdgeSlideNumber;
        var outerEdgeLimit = _.getOuterEdgeLimit();
        _.$slideTrack.find('.slick-slide').each(function(index, slide) {
            ...
            if (-outerEdgeLimit < slideRightBoundary) {
